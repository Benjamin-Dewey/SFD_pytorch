...
output1 = detectGender(testImage1, myModel).data.numpy()
output2 = detectGender(testImage2, myModel).data.numpy()
output3 = detectGender(testImage3, myModel).data.numpy()
output4 = detectGender(testImage4, myModel).data.numpy()
output5 = detectGender(testImage5, myModel).data.numpy()
output6 = detectGender(testImage6, myModel).data.numpy()
